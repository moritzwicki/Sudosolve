...
import sudokugeneratorEasy as sgE
...
def drawGridEasy(entries):
    ...
    submitButton = tk.Button(root, text="Correcting", command=lambda: cor.getEingabenEasy(entries))
    submitButton.grid(row=10, column=10)
    sgE.createEasy(entries)
